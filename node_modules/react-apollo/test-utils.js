...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('apollo-client'), require('react-dom/server'), require('apollo-link'), require('graphql/language/printer'), require('apollo-utilities'), require('lodash'), require('apollo-cache-inmemory')) : typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'apollo-client', 'react-dom/server', 'apollo-link', 'graphql/language/printer', 'apollo-utilities', 'lodash', 'apollo-cache-inmemory'], factory) : factory(global['react-apollo'] = {}, global.React, global.PropTypes, global.ApolloClient, global.ReactDOM, global.apolloLink, global.printer, global.apolloUtilities, global.lodash, global.apolloCacheInmemory);
})(undefined, function (exports, React, PropTypes, ApolloClient, ReactDOM, apolloLink, printer, apolloUtilities, lodash, apolloCacheInmemory) {
    'use strict';

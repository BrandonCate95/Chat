...
var Query = function (_super) {
        ...
        _this.getQueryResult = function () {
            ...
            if (_this.props.skip) {
                ...
                if (errors && errors.length > 0) {
                    error = new _apolloClient.ApolloError({ graphQLErrors: errors });
                }
    ...
    Query.prototype.extractOptsFromProps = function (props) {
        ...
        this.operation = (0, _parser.parser)(query);
        invariant(this.operation.type === _parser.DocumentType.Query, "The <Query /> component requires a graphql query, but got a " + (this.operation.type === _parser.DocumentType.Mutation ? 'mutation' : 'subscription') + ".");
        return compact({
            variables: variables,

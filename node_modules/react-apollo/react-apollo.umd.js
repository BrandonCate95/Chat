...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('apollo-client'), require('react-dom/server')) : typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'apollo-client', 'react-dom/server'], factory) : factory(global['react-apollo'] = {}, global.React, global.PropTypes, global.apolloClient, global.ReactDOM);
})(undefined, function (exports, React, PropTypes, apolloClient, ReactDOM) {
    'use strict';
    ...
    function getPromisesFromTree(_a) {
        var rootElement = _a.rootElement,
            rootContext = _a.rootContext,
            rootNewContext = _a.rootNewContext;
        var promises = [];
    ...
    function getDataAndErrorsFromTree(rootElement, rootContext, storeError, rootNewContext) {
        ...
        var mappedPromises = promises.map(function (_a) {
            var promise = _a.promise,
                ...
                newContext = _a.newContext;
            return promise.then(function (_) {
                return getDataAndErrorsFromTree(instance.render(), context, storeError, newContext);
            }).catch(function (e) {
                return storeError(e);
            });
        });

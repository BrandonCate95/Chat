...
var Mutation = function (_super) {
    ...
    function Mutation(props, context) {
        ...
        _this.onMutationCompleted = function (response, mutationId) {
            ...
            var error = errors && errors.length > 0 ? new _apolloClient.ApolloError({ graphQLErrors: errors }) : undefined;
        ...
        _this.verifyDocumentIsMutation = function (mutation) {
            var operation = (0, _parser.parser)(mutation);
            invariant(operation.type === _parser.DocumentType.Mutation, "The <Mutation /> component requires a graphql mutation, but got a " + (operation.type === _parser.DocumentType.Query ? 'query' : 'subscription') + ".");
        };
        _this.client = (0, _componentUtils.getClient)(props, context);
    ...
    Mutation.prototype.componentWillReceiveProps = function (nextProps, nextContext) {
        var nextClient = (0, _componentUtils.getClient)(nextProps, nextContext);

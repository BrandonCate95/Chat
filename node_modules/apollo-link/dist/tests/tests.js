...
describe('Exports', function () {
    ...
    describe('BatchLink', function () {
        it('constructor', function () {
            chai_1.assert.doesNotThrow(function () {
                return new Allpollo.BatchLink({ batchHandler: function batchHandler() {
                        return void 0;
                    } });
            });
        });
    ...
    describe('BatchHttpLink', function () {
        it('constructor', function () {
            chai_1.assert.doesNotThrow(function () {
                return new Allpollo.BatchHttpLink();
            });
        });
    });
    ...
    describe('SetContextLink', function () {
        it('constructor', function () {
            chai_1.assert.doesNotThrow(function () {
                return new Allpollo.SetContextLink();
            });
        });
    });
    describe('PollingLink', function () {
        it('constructor', function () {
            chai_1.assert.doesNotThrow(function () {
                return new Allpollo.PollingLink(function () {
                    return 1;
                });
            });
        });
    ...
    describe('Link Core', function () {
        describe('execute', function () {
            it('exists', function () {
                chai_1.assert.doesNotThrow(function () {
                    Allpollo.execute(Allpollo.ApolloLink.from([function () {
                        return null;
                    }]), {});
                });
            });

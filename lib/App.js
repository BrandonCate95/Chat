...
var LoadableHeader = (0, _reactLoadable2.default)({
    loader: function loader() {
        return Promise.resolve().then(function () {
            return _interopRequireWildcard(require('./components/Header'));
        });
    },
...
var App = function App(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { className: 'col col-md-8 col-lg-6', style: { padding: '0', display: 'flex', flexDirection: 'column', maxHeight: '100vh', minHeight: '0' } },
                _react2.default.createElement(LoadableHeader, {
                    username: username
                }),
                _react2.default.createElement(
                    _Switch3.default,
...
(function () {
    ...
    reactHotLoader.register(LoadableHeader, 'LoadableHeader', 'src/App.js');
    reactHotLoader.register(LoadableHome, 'LoadableHome', 'src/App.js');
    reactHotLoader.register(LoadableAbout, 'LoadableAbout', 'src/App.js');
    reactHotLoader.register(LoadableContact, 'LoadableContact', 'src/App.js');

...
var App = function App(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { className: 'col col-md-8 col-lg-6 App_hello_bljJR-dNraS-8TrYmjIZ3', style: { padding: '0', display: 'flex', flexDirection: 'column', maxHeight: '100vh', minHeight: '0' } },
...
function chooseHot(comp) {
    if (module.hot) return (0, _reactHotLoader.hot)(module)(comp);else return comp;
}

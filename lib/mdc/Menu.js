...
(function () {
    ...
    reactHotLoader.register(Menu, 'Menu', 'src/mdc/Menu.js');
    reactHotLoader.register(MenuContainer, 'MenuContainer', 'src/mdc/Menu.js');
    reactHotLoader.register(_default, 'default', 'src/mdc/Menu.js');
    leaveModule(module);
})();

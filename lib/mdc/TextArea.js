...
(function () {
    ...
    reactHotLoader.register(LoadableCreateMessageButton, 'LoadableCreateMessageButton', 'src/mdc/TextArea.js');
    reactHotLoader.register(style, 'style', 'src/mdc/TextArea.js');
    reactHotLoader.register(TextArea, 'TextArea', 'src/mdc/TextArea.js');
    reactHotLoader.register(_default, 'default', 'src/mdc/TextArea.js');
    leaveModule(module);
})();

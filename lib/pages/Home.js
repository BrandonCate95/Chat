...
(function () {
    ...
    reactHotLoader.register(LoadableTextArea, 'LoadableTextArea', 'src/pages/Home.js');
    reactHotLoader.register(Home, 'Home', 'src/pages/Home.js');
    reactHotLoader.register(_default, 'default', 'src/pages/Home.js');
    leaveModule(module);
})();
